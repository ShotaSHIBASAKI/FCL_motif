...
if(round(cor.test(na.omit(df_emp)$FCL_long, na.omit(df_emp)$Richness, method='spearman')$p.value)==0){
  r1=r1+annotate(geom="text", x=40, y=9, label=paste0('corr.=', round(cor.test(na.omit(df_emp)$FCL_long, na.omit(df_emp)$Richness, method='spearman')$estimate, 3), ', p.val<0.001'), size=5)
} else{
  r1=r1+annotate(geom="text", x=40, y=9, label=paste0('corr.=', round(cor.test(na.omit(df_emp)$FCL_long, na.omit(df_emp)$Richness, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(na.omit(df_emp)$FCL_long, na.omit(df_emp)$Richness, method='spearman')$p.value, 3)), size=5)
}
...
if(round(cor.test(df_emp$FCL_mean, df_emp$Richness, method='spearman')$p.value,3)==0){
  r2=r2+annotate(geom="text", x=40, y=4.5, label=paste0('corr.=', round(cor.test(df_emp$FCL_mean, df_emp$Richness, method='spearman')$estimate, 3), ', p.val<0.001'), size=5)
}else{
  r2=r2+annotate(geom="text", x=40, y=4.5, label=paste0('corr.=', round(cor.test(df_emp$FCL_mean, df_emp$Richness, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(df_emp$FCL_mean, df_emp$Richness, method='spearman')$p.value, 3)), size=5)
}
...
if(round(cor.test(df_emp$FCL_short, df_emp$Richness, method='spearman')$p.value, 3)==0){
   r3=r3+annotate(geom="text", x=40, y=3.75, label=paste0('corr.=', round(cor.test(df_emp$FCL_short, df_emp$Richness, method='spearman')$estimate, 3), ', p.val<0.001'), size=5)
}else{
   r3=r3+annotate(geom="text", x=40, y=3.75, label=paste0('corr.=', round(cor.test(df_emp$FCL_short, df_emp$Richness, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(df_emp$FCL_short, df_emp$Richness, method='spearman')$p.value, 3)), size=5)
}
...
if(round(cor.test(df_emp$FCL_long, df_emp$Chain, method='spearman')$p.value)==0){
  m1=m1+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=9, label=paste0('corr.=', round(cor.test(df_emp$FCL_long, df_emp$Chain, method='spearman')$estimate, 3), ', p.val<0.001' ), size=5)
}else{
m1=m1+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=9, label=paste0('corr.=', round(cor.test(df_emp$FCL_long, df_emp$Chain, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(df_emp$FCL_long, df_emp$Chain, method='spearman')$p.value, 3)), size=5)
}
...
if(round(cor.test(df_emp$FCL_long, df_emp$Omnivory, method='spearman')$p.value, 3)==0){
  m2=m2+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=9, label=paste0('corr.=', round(cor.test(df_emp$FCL_long, df_emp$Omnivory, method='spearman')$estimate, 3), ', p.val<0.001'), size=5)
}else{
  m2=m2+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=9, label=paste0('corr.=', round(cor.test(df_emp$FCL_long, df_emp$Omnivory, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(df_emp$FCL_long, df_emp$Omnivory, method='spearman')$p.value, 3)), size=5)
}
...
if(round(cor.test(df_emp$FCL_long, df_emp$Apparent, method='spearman')$p.value, 3)==0){
 m3= m3+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=9, label=paste0('corr.=', round(cor.test(df_emp$FCL_long, df_emp$Apparent, method='spearman')$estimate, 3), ', p.val<0.001'), size=5)
}else{
m3=m3+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=9, label=paste0('corr.=', round(cor.test(df_emp$FCL_long, df_emp$Apparent, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(df_emp$FCL_long, df_emp$Apparent, method='spearman')$p.value, 3)), size=5)
}
...
if(round(cor.test(df_emp$FCL_long, df_emp$Exploitative, method='spearman')$p.value, 3)==0){
  m4=m4+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=9, label=paste0('corr.=', round(cor.test(df_emp$FCL_long, df_emp$Exploitative, method='spearman')$estimate, 3), ', p.val<0.001'), size=5)
}else{
m4=m4+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=9, label=paste0('corr.=', round(cor.test(df_emp$FCL_long, df_emp$Exploitative, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(df_emp$FCL_long, df_emp$Exploitative, method='spearman')$p.value, 3)), size=5)
}
...
if(round(cor.test(df_emp$FCL_mean, df_emp$Chain, method='spearman')$p.value, 3)==0){
  m5=m5+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=4.5, label=paste0('corr.=', round(cor.test(df_emp$FCL_mean, df_emp$Chain, method='spearman')$estimate, 3), ', p.val<0.001'), size=5)
}else{
m5=m5+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=4.5, label=paste0('corr.=', round(cor.test(df_emp$FCL_mean, df_emp$Chain, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(df_emp$FCL_mean, df_emp$Chain, method='spearman')$p.value, 3)), size=5)
}
...
if(round(cor.test(df_emp$FCL_mean, df_emp$Omnivory, method='spearman')$p.value, 3)==0){
  m6=m6+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=4.5, label=paste0('corr.=', round(cor.test(df_emp$FCL_mean, df_emp$Omnivory, method='spearman')$estimate, 3), ', p.val<0.001'), size=5)
}else{
m6=m6+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=4.5, label=paste0('corr.=', round(cor.test(df_emp$FCL_mean, df_emp$Omnivory, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(df_emp$FCL_mean, df_emp$Omnivory, method='spearman')$p.value, 3)), size=5)
}
...
if(round(cor.test(df_emp$FCL_mean, df_emp$Apparent, method='spearman')$p.value, 3)==0){
   m7=m7+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=4.5, label=paste0('corr.=', round(cor.test(df_emp$FCL_mean, df_emp$Apparent, method='spearman')$estimate, 3), ', p.val<0.001'), size=5)
}else{
  m7=m7+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=4.5, label=paste0('corr.=', round(cor.test(df_emp$FCL_mean, df_emp$Apparent, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(df_emp$FCL_mean, df_emp$Apparent, method='spearman')$p.value, 3)), size=5)
}
...
if(round(cor.test(df_emp$FCL_mean, df_emp$Exploitative, method='spearman')$p.value, 3)==0){
  m8=m8+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=4.5, label=paste0('corr.=', round(cor.test(df_emp$FCL_mean, df_emp$Exploitative, method='spearman')$estimate, 3), ', p.val<0.001'), size=5)
}else{
m8=m8+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=4.5, label=paste0('corr.=', round(cor.test(df_emp$FCL_mean, df_emp$Exploitative, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(df_emp$FCL_mean, df_emp$Exploitative, method='spearman')$p.value, 3)), size=5)
}
...
if(round(cor.test(df_emp$FCL_short, df_emp$Chain, method='spearman')$p.value, 3)==0){
  m9=m9+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=3.75, label=paste0('corr.=', round(cor.test(df_emp$FCL_short, df_emp$Chain, method='spearman')$estimate, 3), ', p.val<0.001'), size=5)
}else{
  m9=m9+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=3.75, label=paste0('corr.=', round(cor.test(df_emp$FCL_short, df_emp$Chain, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(df_emp$FCL_short, df_emp$Chain, method='spearman')$p.value, 3)), size=5)
}
...
if(round(cor.test(df_emp$FCL_short, df_emp$Omnivory, method='spearman')$p.value, 3)==0){
  m10=m10 +xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=3.75, label=paste0('corr.=', round(cor.test(df_emp$FCL_short, df_emp$Omnivory, method='spearman')$estimate, 3), ', p.val<0.001'), size=5)
}else{
  m10=m10 +xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=3.75, label=paste0('corr.=', round(cor.test(df_emp$FCL_short, df_emp$Omnivory, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(df_emp$FCL_short, df_emp$Omnivory, method='spearman')$p.value, 3)), size=5)
}
...
if(round(cor.test(df_emp$FCL_short, df_emp$Apparent, method='spearman')$p.value, 3)==0){
   m11=m11+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=3.75, label=paste0('corr.=', round(cor.test(df_emp$FCL_short, df_emp$Apparent, method='spearman')$estimate, 3), ', p.val<0.001'), size=5)
}else{
  m11=m11+xlim(c(0,1.0))+annotate(geom="text", x=0.4, y=3.75, label=paste0('corr.=', round(cor.test(df_emp$FCL_short, df_emp$Apparent, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(df_emp$FCL_short, df_emp$Apparent, method='spearman')$p.value, 3)), size=5)
}
...
if(round(cor.test(df_emp$FCL_short, df_emp$Exploitative, method='spearman')$p.value, 3)==0){
  m12=m12+annotate(geom="text", x=0.4, y=3.75, label=paste0('corr.=', round(cor.test(df_emp$FCL_short, df_emp$Exploitative, method='spearman')$estimate, 3), ', p.val<0.001'), size=5)
}else{m12=m12+annotate(geom="text", x=0.4, y=3.75, label=paste0('corr.=', round(cor.test(df_emp$FCL_short, df_emp$Exploitative, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(df_emp$FCL_short, df_emp$Exploitative, method='spearman')$p.value, 3)), size=5)
}
...
ggsave('./FCL_empirical.pdf', width=12, height=12)
```
...
g1=ggplot(d_dist, aes(x=disturbance, y=FCL, color=factor(ecosystem), fill=factor(ecosystem)))+
  ...
  theme(
    ...
    legend.position = 'none'
                    ...
                    ymax = fixed_coef11[2,3]*disturbance+fixed_coef11[1,3]), alpha=0.3, color=NA, fill='#E69F00')+
   geom_ribbon(aes(x = disturbance,
                  ymin = fixed_coef12[2,1]*disturbance+fixed_coef12[1,1],
                  ymax = fixed_coef12[2,3]*disturbance+fixed_coef12[1,3]), alpha=0.3, color=NA, fill='#56B4E9')

for(i in 1:nrow(random_coef11)){
  #plot random effects
...
g2=ggplot(d_dist, aes(x=disturbance, y=richness, color=factor(ecosystem), fill=factor(ecosystem)))+
  ...
  theme(
    ...
    legend.title = element_text(size = 14)
                    ...
                    ymax = fixed_coef21[2,3]*disturbance+fixed_coef21[1,3]), alpha=0.3, color=NA, fill='#E69F00')+
   geom_ribbon(aes(x = disturbance,
                  ymin = fixed_coef22[2,1]*disturbance+fixed_coef22[1,1],
                  ymax = fixed_coef22[2,3]*disturbance+fixed_coef22[1,3]), alpha=0.3, color=NA, fill='#56B4E9')

for(i in 1:nrow(random_coef21)){
  #plot random effects
...
g3=ggplot(d_eco, aes(x=ecosystem, y=FCL, color=factor(disturbance), fill=factor(disturbance)))+
   ...
   theme(
    ...
    legend.position = 'none'
                    ...
                    ymax = fixed_coef31[2,3]*ecosystem+fixed_coef31[1,3]), alpha=0.3, color=NA, fill='#E69F00')+
   geom_ribbon(aes(x = ecosystem,
                  ymin = fixed_coef32[2,1]*ecosystem+fixed_coef32[1,1],
                  ymax = fixed_coef32[2,3]*ecosystem+fixed_coef32[1,3]), alpha=0.3, color=NA, fill='#56B4E9')

for(i in 1:nrow(random_coef31)){
  #plot random effects
...
g4=ggplot(d_eco, aes(x=ecosystem, y=richness, color=factor(disturbance), fill=factor(disturbance)))+
  ...
  theme(
    ...
    legend.title = element_text(size = 14)
                    ...
                    ymax = fixed_coef41[2,3]*ecosystem+fixed_coef41[1,3]), alpha=0.3, color=NA, fill='#E69F00')+
   geom_ribbon(aes(x = ecosystem,
                  ymin = fixed_coef42[2,1]*ecosystem+fixed_coef42[1,1],
                  ymax = fixed_coef42[2,3]*ecosystem+fixed_coef42[1,3]), alpha=0.3, color=NA, fill='#56B4E9')

for(i in 1:nrow(random_coef41)){
  #plot random effects
