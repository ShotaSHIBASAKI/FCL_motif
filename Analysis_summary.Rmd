...
PlotCumulative =function(df, fname){
  ...
  g1=g1+xlim(c(0, 32))+ylim(c(0, 0.2))+theme(
  axis.text.x = element_text(size=14),
    axis.title.x = element_text(size=20),
     axis.text.y = element_text(size=14),
    axis.title.y = element_text(size=20),
  ...
  g2=g2+xlim(c(0, 32))+ylim(c(0, 0.2))+theme(
  axis.text.x = element_text(size=14),
    axis.title.x = element_text(size=20),
     axis.text.y = element_text(size=14),
    axis.title.y = element_text(size=20),
  ...
  g3=g3+xlim(c(0, 32))+ylim(c(0, 0.2))+theme(
  axis.text.x = element_text(size=14),
    axis.title.x = element_text(size=20),
     axis.text.y = element_text(size=14),
    axis.title.y = element_text(size=20),
  ...
  g4=g4+xlim(c(0, 1))+ylim(c(0, 5))+theme(
  axis.text.x = element_text(size=14),
    axis.title.x = element_text(size=20),
     axis.text.y = element_text(size=14),
    axis.title.y = element_text(size=20),
  ...
  g5=g5+xlim(c(0, 1))+ylim(c(0, 5))+theme(
  axis.text.x = element_text(size=14),
    axis.title.x = element_text(size=20),
     axis.text.y = element_text(size=14),
    axis.title.y = element_text(size=20),
  ...
  g6=g6+xlim(c(0, 1))+ylim(c(0,5))+theme(
  axis.text.x = element_text(size=14),
    axis.title.x = element_text(size=20),
     axis.text.y = element_text(size=14),
    axis.title.y = element_text(size=20),
...
g3=g3+xlab('Richness')+ylab('Density')  
g3=g3+xlim(c(0, 32))+ylim(c(0, 0.25))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
...
g4=g4+xlab('Chain')+ylab('Density')  
g4=g4+xlim(c(0, 1))+ylim(c(0, 7))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
...
g5=g5+xlab('Chain')+ylab('Density')  
g5=g5+xlim(c(0, 1))+ylim(c(0, 7))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20))+labs(linetype = "Disturbance", color='Ecosystem')
...
g6=g6+xlab('Chain')+ylab('Density')  
g6=g6+xlim(c(0, 1))+ylim(c(0, 7))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20))+labs(linetype = "Disturbance", color='Ecosystem')
...
Scatter=function(data, gname, alpha=1){
  ...
  g3=ggplot(data, aes(x=Richness, y=Apparent), alpha=alpha) + geom_point()+ylim(0,1)+theme(
    axis.text.x = element_text(size=14),
      axis.title.x = element_text(size=20),
       axis.text.y = element_text(size=14),
      axis.title.y = element_text(size=20))+annotate(geom="text", x=0.5*max(data$Richness), y=0.8, label=paste0('corr.=', round(cor.test(na.omit(data)$Richness, na.omit(data)$Apparent, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(na.omit(data)$Richness, na.omit(data)$Apparent, method='spearman')$p.value, 3)), size=6)
  g4=ggplot(data, aes(x=Richness, y=Exploitative), alpha=alpha) + geom_point()+ylim(0,1)+theme(
    axis.text.x = element_text(size=14),
      axis.title.x = element_text(size=20),
       axis.text.y = element_text(size=14),
      axis.title.y = element_text(size=20))+annotate(geom="text", x=0.5*max(data$Richness), y=0.8, label=paste0('corr.=', round(cor.test(na.omit(data)$Richness, na.omit(data)$Exploitative, method='spearman')$estimate, 3), ', p.val=',  round(cor.test(na.omit(data)$Richness, na.omit(data)$Exploitative, method='spearman')$p.value, 3)), size=6)
  g=g1+g2+g3+g4+plot_layout(nrow = 2)+plot_annotation(tag_levels = "A")&theme(plot.tag = element_text(size = 32))
