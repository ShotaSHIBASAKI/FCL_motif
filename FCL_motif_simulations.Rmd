...
ggsave('FCL_simulation_environemnt.pdf', width=12, height=9)
```
We also plot FCL against richness
```{r Richness}
p1=ggplot(df_long, aes(x=richness, y=FCL, size=3, alpha=0.005))+geom_point(color='black')+ylab('FCL long')+xlab("Richness")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=3, y=11, label=paste0('corr.=', round(cor.test(df_long$FCL, df_long$richness, method='spearman')$estimate, 3)), size=5)
p2=ggplot(df_mean, aes(x=richness, y=FCL, size=3, alpha=0.005))+geom_point(color='black')+ylab('FCL mean')+xlab("Richness")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=3, y=9, label=paste0('corr.=', round(cor.test(df_mean$FCL, df_mean$richness, method='spearman')$estimate, 3)), size=5)
p3=ggplot(df_short, aes(x=richness, y=FCL, size=3, alpha=0.005))+geom_point(color='black')+ylab('FCL short')+xlab("Richness")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=3, y=9, label=paste0('corr.=', round(cor.test(df_short$FCL, df_short$richness, method='spearman')$estimate, 3)), size=5)
p1+p2+p3+plot_layout(nrow = 4,)+plot_annotation(tag_levels = "A")&theme(plot.tag = element_text(size = 32))
ggsave('FCL_simulation_richness.png', width=9, height=12)
```

We can see that FCL correlate with chain motif, disturbance, and ecosystem sizes, respectively, in any definition. Then, we can ask whether disturbance and ecosystem size affect the fractions of motives

```{r Plot richness and chain motif against enviornments}
p1=ggplot(df_long, aes(x=factor(resource), y=chain))+geom_violin(color='#7570b3')+ylab('Chain in long')+xlab("Resource")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=2, y=1.1, label=paste0('corr.=', round(cor.test(df_long$chain, df_long$resource, method='spearman')$estimate, 3)), size=5)

p2=ggplot(df_long, aes(x=factor(disturbance), y=chain))+geom_violin(color='#d95f02')+ylab('Chain in long')+xlab("Disturbance")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=1.5, y=1.1, label=paste0('corr.=', round(cor.test(df_long$chain, df_long$disturbance, method='spearman')$estimate, 3)), size=5)

p3=ggplot(df_long, aes(x=factor(ecosystem), y=chain))+geom_violin(color='#1b9e77')+ylab('Chain in long')+xlab("Ecosystem")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=1.5, y=1.1, label=paste0('corr.=', round(cor.test(df_long$chain, df_long$ecosystem, method='spearman')$estimate, 3)), size=5)

p4=ggplot(df_mean, aes(x=factor(resource), y=chain))+geom_violin(color='#7570b3')+ylab('Chain in mean')+xlab("Resource")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=2, y=1.1, label=paste0('corr.=', round(cor.test(df_mean$chain, df_mean$resource, method='spearman')$estimate, 3)), size=5)

p5=ggplot(df_mean, aes(x=factor(disturbance), y=chain))+geom_violin(color='#d95f02')+ylab('Chain in mean')+xlab("Disturbance")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=1.5, y=1.1, label=paste0('corr.=', round(cor.test(df_mean$chain, df_mean$disturbance, method='spearman')$estimate, 3)), size=5)

p6=ggplot(df_mean, aes(x=factor(ecosystem), y=chain))+geom_violin(color='#1b9e77')+ylab('Chain in mean')+xlab("Ecosystem")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=1.5, y=1.1, label=paste0('corr.=', round(cor.test(df_mean$chain, df_mean$ecosystem, method='spearman')$estimate, 3)), size=5)

p7=ggplot(df_short, aes(x=factor(resource), y=chain))+geom_violin(color='#7570b3')+ylab('Chain in short')+xlab("Resource")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=2, y=1.1, label=paste0('corr.=', round(cor.test(df_short$chain, df_short$resource, method='spearman')$estimate, 3)), size=5)

p8=ggplot(df_short, aes(x=factor(disturbance), y=chain))+geom_violin(color='#d95f02')+ylab('Chain in short')+xlab("Disturbance")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=1.5, y=1.1, label=paste0('corr.=', round(cor.test(df_short$chain, df_short$disturbance, method='spearman')$estimate, 3)), size=5)

p9=ggplot(df_short, aes(x=factor(ecosystem), y=chain))+geom_violin(color='#1b9e77')+ylab('Chain in short')+xlab("Ecosystem")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=1.5, y=1.1, label=paste0('corr.=', round(cor.test(df_short$chain, df_short$ecosystem, method='spearman')$estimate, 3)), size=5)

p1+p4+p7+p2+p5+p8+p3+p6+p9+plot_layout(nrow = 3,)+plot_annotation(tag_levels = "A")&theme(plot.tag = element_text(size = 32))
ggsave('Simulation_chain_enviornment.pdf', width=12, height=12)


#==============================================
p1=ggplot(df_long, aes(x=factor(resource), y=richness))+geom_violin(color='#7570b3')+ylab('Richness in long')+xlab("Resource")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=2, y=31, label=paste0('corr.=', round(cor.test(df_long$richness, df_long$resource, method='spearman')$estimate, 3)), size=5)

p2=ggplot(df_long, aes(x=factor(disturbance), y=richness))+geom_violin(color='#d95f02')+ylab('Richness in long')+xlab("Disturbance")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=1.5, y=31, label=paste0('corr.=', round(cor.test(df_long$richness, df_long$disturbance, method='spearman')$estimate, 3)), size=5)

p3=ggplot(df_long, aes(x=factor(ecosystem), y=richness))+geom_violin(color='#1b9e77')+ylab('Richness in long')+xlab("Ecosystem")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=1.5, y=31, label=paste0('corr.=', round(cor.test(df_long$richness, df_long$ecosystem, method='spearman')$estimate, 3)), size=5)

p4=ggplot(df_mean, aes(x=factor(resource), y=richness))+geom_violin(color='#7570b3')+ylab('Richness in mean')+xlab("Resource")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=2, y=31, label=paste0('corr.=', round(cor.test(df_mean$richness, df_mean$resource, method='spearman')$estimate, 3)), size=5)

p5=ggplot(df_mean, aes(x=factor(disturbance), y=richness))+geom_violin(color='#d95f02')+ylab('Richness in mean')+xlab("Disturbance")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=1.5, y=31, label=paste0('corr.=', round(cor.test(df_mean$richness, df_mean$disturbance, method='spearman')$estimate, 3)), size=5)

p6=ggplot(df_mean, aes(x=factor(ecosystem), y=richness))+geom_violin(color='#1b9e77')+ylab('Richness in mean')+xlab("Ecosystem")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=1.5, y=31, label=paste0('corr.=', round(cor.test(df_mean$richness, df_mean$ecosystem, method='spearman')$estimate, 3)), size=5)

p7=ggplot(df_short, aes(x=factor(resource), y=richness))+geom_violin(color='#7570b3')+ylab('Richness in short')+xlab("Resource")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=2, y=31, label=paste0('corr.=', round(cor.test(df_short$chain, df_short$resource, method='spearman')$estimate, 3)), size=5)

p8=ggplot(df_short, aes(x=factor(disturbance), y=richness))+geom_violin(color='#d95f02')+ylab('Richness in short')+xlab("Disturbance")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=1.5, y=31, label=paste0('corr.=', round(cor.test(df_short$richness, df_short$disturbance, method='spearman')$estimate, 3)), size=5)

p9=ggplot(df_short, aes(x=factor(ecosystem), y=richness))+geom_violin(color='#1b9e77')+ylab('Richness in short')+xlab("Ecosystem")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+annotate(geom="text", x=1.5, y=31, label=paste0('corr.=', round(cor.test(df_short$richness, df_short$ecosystem, method='spearman')$estimate, 3)), size=5)

p1+p4+p7+p2+p5+p8+p3+p6+p9+plot_layout(nrow = 3,)+plot_annotation(tag_levels = "A")&theme(plot.tag = element_text(size = 32))
ggsave('Simulation_richness_enviornment.pdf', width=12, height=12)
```

```{r regression}
library(car)
# Next we performmodel comparison
#df_long=read.csv("FCL_long_simulations_summary.csv")
...
#[, 2:ncol(df_long)]=scale(df_long[, 2:ncol(df_long)])
b_start=1.5
AIC_cal= function(df){
  #-------------Model description------------------------
...
#AIC_cal(df_short)
```
It seems that model26 is the best model in all cases. However, using this funciton in FCL short and long would be problematic because
they are discrete...

Now focus on FCL mean for awhile
```{r}
...
summary(model_mean)
```
Now plot FCL against chian motif and richness and comapre the model.

```{r Evaluate the model of FCL mean}

df_long$predict=6.92*(1-exp(-0.08*df_long$richness))-1.49*df_long$chain^2+3.15*df_long$chain-1
...
axis.text.x = element_text(size=14),
  ...
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+stat_function(fun = function(x) 6.92*(1-exp(-0.08*x))-1.49*mean(df_long$chain)^2+3.15*mean(df_long$chain)-1, color='red')
...
# FCL mean 
df_mean$predict=3.81*(1-exp(-0.17*df_mean$richness))-0.91*df_mean$chain^2+2.43*df_mean$chain-1
...
axis.text.x = element_text(size=14),
  ...
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+stat_function(fun = function(x) 3.81*(1-exp(-0.17*x))-0.91*mean(df_mean$chain)^2+2.43*mean(df_mean$chain)-1, color='red')
...
#FCL short
df_short$predict=2.98*(1-exp(-0.24*df_short$richness))-0.69*df_short$chain^2+2.13*df_short$chain-1
...
axis.text.x = element_text(size=14),
  ...
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+stat_function(fun = function(x) 2.98*(1-exp(-0.24*x))-0.69*mean(df_short$chain)^2+2.13*mean(df_short$chain)-1, color='red')
...
axis.text.x = element_text(size=14),
  ...
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+stat_function(fun = function(x) 2.98*(1-exp(-0.24*mean(df_chain$richness)))-0.69*x^2+2.13*x-1, color='red')
...
Plot the cumulative of richness

```{r}
g1=ggplot(df_mean, aes(richness, linetype=factor(resource)))+ stat_ecdf(geom = "step", color='#7570b3')
g1=g1+xlab('Richness')+ylab('Probability')  
...
g2=ggplot(df_mean, aes(richness, linetype=factor(disturbance)))+ stat_ecdf(geom = "step", color='#d95f02')
g2=g2+xlab('Richness')+ylab('Probability')  
...
g3=ggplot(df_mean, aes(richness, linetype=factor(ecosystem)))+ stat_ecdf(geom = "step", color='#1b9e77')
g3=g3+xlab('Richness')+ylab('Probability')  
...
g4=ggplot(df_mean, aes(chain, linetype=factor(resource)))+ stat_ecdf(geom = "step", color='#7570b3')
g4=g4+xlab('Chain')+ylab('Probability')  
...
g5=ggplot(df_mean, aes(chain, linetype=factor(disturbance)))+ stat_ecdf(geom = "step", color='#d95f02')
g5=g5+xlab('Chain')+ylab('Probability')  
...
g6=ggplot(df_mean, aes(chain, linetype=factor(ecosystem)))+ stat_ecdf(geom = "step", color='#1b9e77')
g6=g6+xlab('Chain')+ylab('Probability')  
...
ggsave('Cumulative_Richness_Chain_mean.pdf', heigh=12, width=12)
```

These pattern seem to explain why the inconsistent pattern in previous studies is reported.
Check wehtehr this holds inFCL long and mean. 
In these cases, FCL is discrete and use Negative Bion would be better than OLS.
...
AIC_cal2= function(df){
  #-------------Model description------------------------
  model1=glm(formula = FCL + 1 ~ richness, family = poisson(link = "log"), 
    data = df)
  model2=nls(FCL ~ a*(1-exp(-b*richness))-1, data=df, start=c(a=max(df$FCL)/2, b=b_start),  
             algorithm='port', lower=c(a=0, b=0), upper=c(a=max(df$FCL)+1, b =10)) # saturating func of richness
  model3=nls(FCL ~ -a*richness^2+b*richness-1, data=df, start=c(a=1, b=1), 
             algorithm='port', lower=c(a=0, b=0), upper=c(a=10, b=10)) # quadratic func of richness
  model4=glm(formula = FCL + 1 ~ chain, family = poisson(link = "log"), 
...
AIC_cal2(df_short)
```
Saturation + quadratic seem the best in both as well.
```{r}
model_long=nls(FCL ~ a*(1-exp(-b*richness))-c*chain^2+d*chain-1, data=df_long, 
              start=c(a=max(df_long$FCL)/2, b=b_start, c=1, d=1.05), 
              algorithm='port', lower=c(a=0, b=0, c=0, d=0), 
...
```{r}
mean_chain=mean(df_long$chain)
print(mean_chain)
mean_richness=mean(df_long$richness)
print(mean_richness)
g1=ggplot(df_long, aes(x=richness, y=FCL, size=3, alpha=0.000005))+geom_point(color='black')+ylab('FCL long')+xlab("Richness")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
  ...
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+stat_function(fun = function(x) 6.65*(1-exp(-0.09*x))-0.48*mean_chain^2+1.99*mean_chain-1, color='red')
g2=ggplot(df_long, aes(x=chain, y=FCL, size=3, alpha=0.000005))+geom_point(color='black')+ylab('FCL long')+xlab("Chain")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+stat_function(fun = function(x) 6.65*(1-exp(-0.09*mean_richness))-0.48*x^2+1.99*x-1, color='red')
df_long$predict=6.65*(1-exp(-0.09*df_long$richness))-0.48*df_long$chain^2+1.99*df_long$chain-1
g3=ggplot(df_long, aes(x=FCL, y=predict, size=3, alpha=0.000005))+geom_point(color='black')+ylim(c(-1, 6))+xlab('FCL long')+ylab("Model prediction")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
...
g1+g2+g3+plot_annotation(tag_levels = "A")&theme(plot.tag = element_text(size = 32))
ggsave('Modeling_FCLlong.png', width=12, height=8)
```
```{r}
g1=ggplot(df_long, aes(richness, linetype=factor(resource)))+ stat_ecdf(geom = "step", color='#7570b3')
g1=g1+xlab('Richness')+ylab('Probability')  
g1=g1+xlim(c(0, 32))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
...
g2=ggplot(df_long, aes(richness, linetype=factor(disturbance)))+ stat_ecdf(geom = "step", color='#d95f02')
g2=g2+xlab('Richness')+ylab('Probability')  
g2=g2+xlim(c(0, 32))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
...
g3=ggplot(df_long, aes(richness, linetype=factor(ecosystem)))+ stat_ecdf(geom = "step", color='#1b9e77')
g3=g3+xlab('Richness')+ylab('Probability')  
g3=g3+xlim(c(0, 32))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
...
g4=ggplot(df_long, aes(chain, linetype=factor(resource)))+ stat_ecdf(geom = "step", color='#7570b3')
g4=g4+xlab('Chain')+ylab('Probability')  
g4=g4+xlim(c(0, 1))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
...
g5=ggplot(df_long, aes(chain, linetype=factor(disturbance)))+ stat_ecdf(geom = "step", color='#d95f02')
g5=g5+xlab('Chain')+ylab('Probability')  
g5=g5+xlim(c(0, 1))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
...
g6=ggplot(df_long, aes(chain, linetype=factor(ecosystem)))+ stat_ecdf(geom = "step", color='#1b9e77')
g6=g6+xlab('Chain')+ylab('Probability')  
g6=g6+xlim(c(0, 1))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
...
g1+g4+g2+g5+g3+g6+plot_layout(nrow = 3,)+plot_annotation(tag_levels = "A")&theme(plot.tag = element_text(size = 32))
ggsave('Cumulative_Richness_Chain_long.pdf', heigh=12, width=12)
```
```{r}
model_short=nls(FCL ~ a*(1-exp(-b*richness))-c*chain^2+d*chain-1, data=df_short, 
              start=c(a=max(df_short$FCL)/2, b=b_start, c=1, d=1), 
              algorithm='port', lower=c(a=0, b=0, c=0, d=0), 
...
```{r}
mean_chain=mean(df_short$chain)
print(mean_chain)
mean_richness=mean(df_short$richness)
print(mean_richness)
g1=ggplot(df_short, aes(x=richness, y=FCL, size=3, alpha=0.000005))+geom_point(color='black')+ylab('FCL short')+xlab("Richness")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+stat_function(fun = function(x) 2.98*(1-exp(-0.3*x))-0.57*mean_chain^2+1.83*mean_chain-1, color='red')
g2=ggplot(df_short, aes(x=chain, y=FCL, size=3, alpha=0.000005))+geom_point(color='black')+ylab('FCL short')+xlab("Chain")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
  legend.position="none"
  )+stat_function(fun = function(x) 2.98*(1-exp(-0.3*mean_richness))-0.57*x^2+1.83*x-1, color='red')
df_short$predict=2.98*(1-exp(-0.3*df_short$richness))-0.57*df_short$chain^2+1.83*df_short$chain-1
g3=ggplot(df_short, aes(x=FCL, y=predict, size=3, alpha=0.000005))+geom_point(color='black')+ylim(c(-1, 6))+xlab('FCL short')+ylab("Model prediction")+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
   axis.text.y = element_text(size=14),
  axis.title.y = element_text(size=20),
...
g1+g2+g3+plot_annotation(tag_levels = "A")&theme(plot.tag = element_text(size = 32))
ggsave('Modeling_FCLshort.png', width=12, height=8)
```

```{r}
g1=ggplot(df_short, aes(richness, linetype=factor(resource)))+ stat_ecdf(geom = "step", color='#7570b3')
g1=g1+xlab('Richness')+ylab('Probability')  
g1=g1+xlim(c(0, 32))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
...
g2=ggplot(df_short, aes(richness, linetype=factor(disturbance)))+ stat_ecdf(geom = "step", color='#d95f02')
g2=g2+xlab('Richness')+ylab('Probability')  
g2=g2+xlim(c(0, 32))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
...
g3=ggplot(df_short, aes(richness, linetype=factor(ecosystem)))+ stat_ecdf(geom = "step", color='#1b9e77')
g3=g3+xlab('Richness')+ylab('Probability')  
g3=g3+xlim(c(0, 32))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
...
g4=ggplot(df_short, aes(chain, linetype=factor(resource)))+ stat_ecdf(geom = "step", color='#7570b3')
g4=g4+xlab('Chain')+ylab('Probability')  
g4=g4+xlim(c(0, 1))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
...
g5=ggplot(df_short, aes(chain, linetype=factor(disturbance)))+ stat_ecdf(geom = "step", color='#d95f02')
g5=g5+xlab('Chain')+ylab('Probability')  
g5=g5+xlim(c(0, 1))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
...
g6=ggplot(df_short, aes(chain, linetype=factor(ecosystem)))+ stat_ecdf(geom = "step", color='#1b9e77')
g6=g6+xlab('Chain')+ylab('Probability')  
g6=g6+xlim(c(0, 1))+theme(
axis.text.x = element_text(size=14),
  axis.title.x = element_text(size=20),
...
g1+g4+g2+g5+g3+g6+plot_layout(nrow = 3,)+plot_annotation(tag_levels = "A")&theme(plot.tag = element_text(size = 32))
ggsave('Cumulative_Richness_Chain_short.pdf', heigh=12, width=12)
```