...
ggplot(data, aes(x=FCL_short)) + geom_bar()
ggplot(data, aes(x=FCL_long)) + geom_bar()
ggplot(data, aes(x=richness)) + geom_bar()
...
summary(lm(formula = FCL_short ~ richness + s1 +s4, data = df)) # we use ds as intercept
